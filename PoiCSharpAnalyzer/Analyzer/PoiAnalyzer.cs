...
namespace PoiLanguage {
    ...
    internal abstract class PoiAnalyzer : Analyzer {
        ...
        public override void Enter(Node node) {
            switch (node.Id) {
            case (int) PoiConstants.ADD:
                EnterAdd((Token) node);
                break;
            case (int) PoiConstants.SUB:
                EnterSub((Token) node);
                break;
            case (int) PoiConstants.MUL:
                EnterMul((Token) node);
                break;
            case (int) PoiConstants.DIV:
                EnterDiv((Token) node);
                break;
            case (int) PoiConstants.LEFT_PAREN:
                EnterLeftParen((Token) node);
                break;
            case (int) PoiConstants.RIGHT_PAREN:
                EnterRightParen((Token) node);
                break;
            case (int) PoiConstants.NUMBER:
            ...
            case (int) PoiConstants.EXPRESSION:
                ...
                break;
            case (int) PoiConstants.EXPRESSION_TAIL:
                EnterExpressionTail((Production) node);
                break;
            case (int) PoiConstants.TERM:
                EnterTerm((Production) node);
                break;
            case (int) PoiConstants.TERM_TAIL:
                EnterTermTail((Production) node);
                break;
            case (int) PoiConstants.FACTOR:
                EnterFactor((Production) node);
                break;
            case (int) PoiConstants.ATOM:

...
namespace PoiLanguage {
    ...
    internal class PoiParser : RecursiveDescentParser {
        ...
        private void CreatePatterns() {
            ...
            pattern.AddAlternative(alt);
            alt = new ProductionPatternAlternative();
            alt.AddProduction((int) PoiConstants.EVENT_STATEMENT, 1, 1);
            pattern.AddAlternative(alt);
            AddPattern(pattern);
            ...
            pattern = new ProductionPattern((int) PoiConstants.EVENT_STATEMENT,
                                            "EventStatement");
            alt = new ProductionPatternAlternative();
            alt.AddToken((int) PoiConstants.EVENT_TRIGGER, 1, 1);
            alt.AddProduction((int) PoiConstants.EVENT_VARIABLE, 1, 1);
            alt.AddToken((int) PoiConstants.SYMBOL_LEFT_PAREN, 1, 1);
            alt.AddProduction((int) PoiConstants.EXPRESSION, 0, 1);
            alt.AddToken((int) PoiConstants.SYMBOL_RIGHT_PAREN, 1, 1);
            alt.AddToken((int) PoiConstants.SYMBOL_SEMICOLON, 1, 1);
            ...
            pattern = new ProductionPattern((int) PoiConstants.EVENT_VARIABLE,
                                            "EventVariable");
            alt = new ProductionPatternAlternative();
            alt.AddToken((int) PoiConstants.IDENTIFIER, 1, 1);
            pattern.AddAlternative(alt);
